...
<table width="100%">
<tr> <td> ID</td> <td> Owner Name </td> <td> Email </td> <td> Password <td/></tr>
<?php
	...
	if (mysqli_num_rows($result) > 0) 
	{
		...
		{
			$id_temp = $final_result['id'];
			$on_temp = $final_result['ownername'];
			$email_temp = $final_result['email'];
			$pass_temp = $final_result['password'];
			echo "<tr> <td>$id_temp </td> <td> $on_temp </td> <td>$email_temp </td> <td> $pass_temp <td/></tr>";
		}
	}
