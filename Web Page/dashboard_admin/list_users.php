...
<table width="100%">
<tr> <td> ID</td> <td> User Name </td> <td> Email </td> <td> Password <td/></tr>
<?php
	...
	if (mysqli_num_rows($result) > 0) 
	{
		while($final_result = mysqli_fetch_assoc($result))  //fetch line by line
		{
			...
			$un_temp = $final_result['username'];
			$email_temp = $final_result['email'];
			$pass_temp = $final_result['password'];
			echo "<tr> <td>$id_temp </td> <td> $un_temp </td> <td>$email_temp </td> <td> $pass_temp <td/></tr>";
		}
	}
