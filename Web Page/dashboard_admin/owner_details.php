...
<table width="100%">
<tr> <td> node_id </td> <td> node_type </td> <td> owner_name </td> <td>  sensor_type <td/> <td>loc_x</td> <td>loc_y</td> </tr>
<?php
	...
	if (mysqli_num_rows($result) > 0) 
	{
		while($final_result = mysqli_fetch_assoc($result))  //fetch line by line
		{
			...
			$lx_temp = $final_result['loc_x'];
			$ly_temp = $final_result['loc_y'];
			echo "<tr> <td>$id_temp </td> <td> $nt_temp </td> <td>$on_temp </td> <td> $st_temp <td/>  <td> $lx_temp <td/> <td> $ly_temp <td/></tr>";
		}
	}
